...
class Ui_MainWindow(object):
    ...
    def setGoal(self):
        ...
        goal.pose.position.x = self.x_pose
        goal.pose.position.y = self.y_pose
        goal.pose.position.z = 0.0

        
        goal.pose.orientation.x = 0.0
        goal.pose.orientation.y = 0.0
        goal.pose.orientation.z = self.z_orien
        goal.pose.orientation.w = self.w_orien
    ...
    def clbk_goal(self,data):
        ...
        self.x_pose = goal_val['x_pose']
        self.y_pose = goal_val['y_pose']
        self.z_pose = goal_val['z_pose']
        self.x_orien = goal_val['x_orien']
        self.y_orien = goal_val['y_orien']
        self.z_orien = goal_val['z_orien']
        self.w_orien = goal_val['w_orien']
        self.setGoal()
